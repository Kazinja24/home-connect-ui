  ...
  return (
    <div className="space-y-6 animate-slide-up">
      ...
      <Card className="glass-strong border-border/30">
        <CardHeader>
          <CardTitle className="text-lg">{t("tenant.myApplications")}</CardTitle>
        </CardHeader>
          ...
          {isLoading ? (
            ...
            data.map((a: any) => (
              <div key={a.id} className="border rounded-lg p-4 flex items-center justify-between">
                <div>
                  <p className="font-semibold text-foreground">{a.property_title || `${t("common.property")} #${a.property}`}</p>
            ...
            <p className="text-muted-foreground text-sm py-8 text-center">{t("tenant.noApplications")}</p>
          )}
        </CardContent>
      </Card>
    </div>
